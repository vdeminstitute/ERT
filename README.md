...
* RELEASES: ERT 3.0 is based on the V-Dem dataset v11.1. For earlier releases using earlier versions of the V-Dem dataset, see the "Releases" column on the right sight. 
